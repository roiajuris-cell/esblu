...
// Táto stránka nemá verzovaný .md obsah (na rozdiel od terms/privacy/dpa/
// cookies) — je to vždy-aktuálna prevádzková tabuľka dodávateľov, nie
// právne verzovaný dokument s content_hash. DE/EN preklad je preto priamo
// v i18n slovníku (lib/i18n/dictionaries/*.ts, namespace legal.subprocessors),
// nie v legal/ .md súboroch. Obsahovo sa touto zmenou nič nemení — iba
// pridáva zobrazenie v troch jazykoch.
export default async function SubprocessorsPage() {
  ...
  return (
    <PublicLegalLayout
      title={t("legal.titles.subprocessors")}
